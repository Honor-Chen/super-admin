...
const SearchForm = <T extends object>({ ...props }: SearchFormProps<T>) => {
    ...
    useImperativeHandle(
        ...
        () => ({
            ...
            getParams: () => {
                ...
                // find all columns with valueType === 'dateRange'
    ...
    return (
        <div
            ...
            className="super-table-search-form"
            style={{
                marginBottom: "20px",
            }}
        >
            <Form form={form} layout={"inline"} labelCol={{ span: 8 }} wrapperCol={{ span: 16 }}>
                <div
                    style={{
                        width: "100%",
                        display: "grid",
                ...
                >
                    {[...items].slice(0, expandSearchForm ? items.length : maxCol - 1).map(column => (
                        <Form.Item
                            style={{
                                marginInlineEnd: 0,
                            }}
